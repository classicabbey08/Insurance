  ...
  return (
    <div>
      <div className="container-fluid">
        <main className="row">
             <h2>Our Services </h2>
<p>We provide insurance solutions that meet your personal and business needs.</p> 
...
<p>Whether you’re traveling within or outside the country, we’ve got you covered. Our travel plans protect you from unexpected incidents like trip cancellations, lost luggage, or medical emergencies abroad.</p>
